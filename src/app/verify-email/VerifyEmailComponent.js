// src/app/verify-email/VerifyEmailComponent.js
...
export default function VerifyEmailComponent() {
  ...
  const handleSendVerificationCode = async (targetEmail) => {
    ...
    setMessage('');
    try {
      const res = await fetch(`https://my-ecommerce-backend-fzsl.onrender.com/api/auth/send-verification-code`, {
        method: 'PATCH',
  ...
  const handleSubmitVerification = async (e) => {
    ...
    try {
      const res = await fetch(`https://my-ecommerce-backend-fzsl.onrender.com/api/auth/verify-verification-code`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
